...
namespace Sho.Pocket.DataAccess.Sql.EntityFramework.Migrations
{
    ...
    [Migration("20200301212010_AddAssetValueAndUpdatedOnColumns")]
    partial class AddAssetValueAndUpdatedOnColumns
    {
            ...
            modelBuilder.Entity("Sho.Pocket.Domain.Entities.Balance", b =>
                {
                    ...
                    b.HasOne("Sho.Pocket.Domain.Entities.ExchangeRate", "ExchangeRate")
                        .WithMany()
